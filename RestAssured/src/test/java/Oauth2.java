...
public class Oauth2 {
	...
	public void getmethodoauth2() {
		...
		Response getres = given().baseUri(baseuri).auth().oauth2(accesstoken).queryParam("page", 3)
				.queryParam("page_size", 4).queryParam("total_count_required", true).when().get(getpath);
